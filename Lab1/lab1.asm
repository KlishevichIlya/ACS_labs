...
.data
    ...
    message0 db "Lab 1(I LOVE AVS!)", '$'
    message1 db "Program in protected mode", '$'
    message2 db " ", '$'
    message3 db "<------***********-------->", '$'
    enteers db "Hi! We're in protected mode", '$'
    exit db "Bye! We aren't in protected mode", '$'
...
;1
    ...
    mov di, 1290 ; possition
    call WriteString
    
    mov ah, 6; color 
    mov bx, offset message3
    mov di, 1610 ; possition
    call WriteString
